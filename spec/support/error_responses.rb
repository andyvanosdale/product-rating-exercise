# From: https://github.com/eliotsykes/rspec-rails-examples/blob/main/spec/support/error_responses.rb
...
RSpec.configure do |config|
  ...
  # From: https://eliotsykes.com/2017/03/08/realistic-error-responses/
